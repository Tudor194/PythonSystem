...
def open_text_editor():
    ...
    save_button = tk.Button(text_editor, text = "Save", background = "lightgreen", activebackground = "green", command = lambda: save_file_TE(text_area))
